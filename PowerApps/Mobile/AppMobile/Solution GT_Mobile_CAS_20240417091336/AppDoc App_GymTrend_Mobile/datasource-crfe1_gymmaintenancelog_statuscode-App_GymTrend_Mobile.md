...
### crfe1\_gymmaintenancelog\_statuscode

| Property | Value                                |
| -------- | ------------------------------------ |
| Name     | crfe1\_gymmaintenancelog\_statuscode |
| Type     | OptionSetInfo                        |
...
| DisplayName                | Razão do Estado (Gym Maintenance Log)                                                                                                                 |
...
| OptionSetReference         | "OptionSetReferenceItem0": {"OptionSetReferenceEntityName": "Gym Maintenance Log", "OptionSetReferenceColumnName": "statuscode"}                      |
